...
<script>
    ...
    export default{
        ...
        created(){
            UserService.editUserBoard(this.$route.params.id).then(
                (res) => {
                    this.user = res.data.success;
                    console.log(this.user);
                    this.avatar = res.data.success.avatar;
                    if(this.avatar == null)
                        this.avatar = '';
                },
                error => {
        ...
        methods:{
            updateUser(){
                ...
                this.$validator.validate().then(isValid => {
                    if (isValid) {
                        UserService.updateUploadUserBoard(this.$route.params.id, data).then(response => {
                        ...
                        UserService.updateUserBoard(this.$route.params.id, this.user).then(response => {
